                        ...
                        <div class="col m6">
                            ...
                            <div class="row">
                                ...
                                <div id="agosto22" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '22/08')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                ...
                                <div id="agosto29" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '29/08')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                ...
                                <div id="septiembre05" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '05/09')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                ...
                                <div id="septiembre12" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '12/09')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                        ...
                        <div class="col m6">
                            ...
                            <div class="row">
                                ...
                                <div id="agosto24" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '24/08')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <ul class="tabs">
                                        ...
                                        <li class="tab col s3">
                                            <a href="#septiembre17" onclick="cambiarText('#fecha7', '17 de Septiembre')">17/09</a>
                                        </li>
                                    </ul>
                                ...
                                <div id="septiembre03" class="col s12">
                                    ...
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '03/09')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                                <input name="ghora21" type="radio" value="{{ $data->id }}" id="hora{{ $data->id }}" />
                                                <label for="hora{{ $data->id }}">{{ $data->hora }} - {{ 'Cantidad '.$data->cantidad }}</label>
                                            </li>
                                        @endforeach
                                ...
                                <div id="septiembre17" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '17/09')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                                <input name="ghora22" type="radio" value="{{ $data->id }}" id="hora{{ $data->id }}" />
                                                <label for="hora{{ $data->id }}">{{ $data->hora }} - {{ 'Cantidad '.$data->cantidad }}</label>
                                            </li>
                                        @endforeach
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <ul class="tabs">
                                        ...
                                        <li class="tab col s3">
                                            <a href="#septiembre11" onclick="cambiarText('#fecha8', '11 de Septiembre')">11/09</a>
                                        </li>
                                    </ul>
                                ...
                                <div id="agosto28" class="col s12">
                                    ...
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '28/08')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                                <input name="ghora23" type="radio" value="{{ $data->id }}" id="hora{{ $data->id }}" />
                                                <label for="hora{{ $data->id }}">{{ $data->hora }} - {{ 'Cantidad '.$data->cantidad }}</label>
                                            </li>
                                        @endforeach
                                ...
                                <div id="septiembre11" class="col s12">
                                    <ul class="collection">
                                    <?php $dates = DB::table('date_times')->where('fecha', '=', '11/09')->get(); ?>
                                        @foreach($dates as $data)
                                            <li class="collection-item">
                                                <input name="ghora24" type="radio" value="{{ $data->id }}" id="hora{{ $data->id }}" />
                                                <label for="hora{{ $data->id }}">{{ $data->hora }} - {{ 'Cantidad '.$data->cantidad }}</label>
                                            </li>
                                        @endforeach
